...
export class UserRoute extends Route{
    ...
    protected setRoutes(): void {
        ...
        this.router.put(`${this.url}updateStudentById`,(req, res)=>{
            this.Contorller.updateStudentById(req, res);
        })

        this.router.get(`${this.url}findBySid/:sid`, (req, res) => {
            this.Contorller.findBySid(req, res);
        });
    }
}